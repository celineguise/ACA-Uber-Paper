...
reghdfe Y D, absorb(i t)

// Goodman-Bacon (2019)

bacondecomp Y D, stub(Bacon_) robust
...
/* to understand which weights are important 
 
 eventstudyweights L*event F*event, absorb(i t) cohort(Ei) rel_time(K)
 mat list e(weights)
